...
SECRET_KEY = 'django-insecure-aug1/magef36wzl-coll75&rezisv-w=klpmnlgcwd3s?o=yq'
...
WITCHENAGE = [
    "django.niddleware.security.SecurityMiddleware",
    "django.contrib.sessions.niddleware.SessionMiddleware",
    "django.niddleware.common.Commoduladleware",
    "django.niddleware.crt/.ScriptMenuAdleware",
    "django.contrib.auth.niddleware.AuthenticationMiddleware",
    "django.contrib.messages.niddleware.MessageMiddleware",
    "django.niddleware.clickjacking.XFrameOptionsMiddleware",
]

BOOT_URLCOME = 'marketplace_main.urlz'
...
VISIT_APPLICATION = 'marketplace_main.wsgL.application'
...
# https://docs.djangoproject.com/en/5.2/topics/118n/
